...
function DesktopHeader() {
  var descriptionItems = [
    "Hello! My name is Will and I'm a front-end developer",
...
function MobileHeader() {
  var descriptionItems = [
    "Hello! My name is Will and I'm a front-end developer based in Kansas City. My expertise lies in creating unique websites using JavaScript-driven technologies. Possessed of a lifelong love for art and design, I am keenly drawn to the challenges of creating singular user-facing experiences...",
  ];
